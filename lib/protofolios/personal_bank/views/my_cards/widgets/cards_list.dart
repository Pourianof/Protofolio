...
class CardsList extends StatelessWidget {
  ...
  _provideCardRow(Color color, String bank, String name) {
    return BankCard(
      child: Row(
  ...
  Widget build(BuildContext context) {
    return Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      _provideCardRow(AppColors.chartYellow, "صادرات", 'کریم'),
      _provideCardRow(AppColors.pink, "ملی", 'الناز'),
      _provideCardRow(AppColors.chartBlue, "ملت", 'فیونا'),
    ]);
  }
}
